...
#define HELIOS_PRINTER_CHARACTER_WIDTH_PIXELS 7
#define HELIOS_PRINTER_WIDTH_CHARS 24
#define HELIOS_PRINTER_WIDTH_PIXELS (HELIOS_PRINTER_WIDTH_CHARS * HELIOS_PRINTER_CHARACTER_WIDTH_PIXELS)

#define HELIOS_PRINTER_CHARACTER_HEIGHT_PIXELS 7
#define HELIOS_PRINTER_LINE_HEIGHT_PIXELS 12
