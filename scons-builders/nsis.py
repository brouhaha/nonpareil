...
To use it you must copy this file into the scons/SCons/Tools directory
(sorry, that's a SCons limitation, at least with 0.94 and before.  I have
hope for the future)
and put a line like 'env.Tool("NSIS")' into your file.
Then you can do 'env.Installer("foobar")' which will read foobar.nsi and
...
equal to the filename you specified in foobar.nsi
"""
