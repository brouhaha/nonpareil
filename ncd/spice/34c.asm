...
; cold start contant wasn't present
L13521:  p <- 4
         load constant 4
         0 -> c[wp]
         c -> data
...
; dsiplay formatting, compare S02367 in 32E
S16370:  m2 -> c
         b exchange c[w]
         if s 11 = 1
           then go to L16616
...
L16405:  decimal
         ...
         0 -> c[x]		; is exponent >= 10
         p <- 0
         load constant 10
         if a >= c[x]
           then go to L16505	;   yes, force SCI
L16415:  b -> c[w]
         a exchange b[x]
         if s 4 = 1
           then go to L16456
...
; display formatting, compare L02445 in 32E
S16516:  0 -> a[w]
         c -> a[wp]
         a + c -> a[ms]
         0 -> a[wp]
...
L17152:  load constant 9
         p <- 0
         if a >= c[p]
           then go to L17206	; RAD
         c - 1 -> c[p]
         if a >= c[p]
           then go to L17203	; DEG
L17161:  jsb S17140
         p <- 3
         load constant 1
         go to L17170
